        ...
        <div class="flex-1 mt-6">
            <div class="mx-auto flex max-w-lg p-2 justify-start">
                <a
                    ...
                    class="inline-flex items-center rounded-xl bg-slate-100 px-3 py-2 text-slate-700 shadow-sm ring-1 ring-slate-200 hover:bg-slate-200"
                >
                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input
                                ...
                                value="{{ old('direccio') }}"
                                maxlength="255"
                                placeholder="C/ Exemple 123, Barcelona"
                            ...
                            <div id="direccio-map" class="mt-3 hidden h-56 w-full overflow-hidden rounded-lg border border-slate-200"></div>
                            @error('direccio')
                                <p class="mt-1 text-sm text-red-700">{{ $message }}</p>
                            @enderror
                        </div>
